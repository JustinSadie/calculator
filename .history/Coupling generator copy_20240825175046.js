...
function displayResults(){
    if (validateForm()) {
        ...
        document.getElementById('brCouplingSuggest1').value=findColorAndSize(nextNearestValue().firstRecommendation).size.toUpperCase + " - " + findColorAndSize(nextNearestValue().firstRecommendation).color;
        document.getElementById('brCouplingSuggest2').value=findColorAndSize(nextNearestValue().secondrecommendation).size.toUpperCase + " - " + findColorAndSize(nextNearestValue().secondrecommendation).color;
